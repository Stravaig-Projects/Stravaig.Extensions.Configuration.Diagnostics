...
namespace Stravaig.Configuration.Diagnostics.Serilog
{
    ...
    public static class SerilogConnectionStringExtensions
    {
        /// <summary>
        ...
        public static void LogConnectionString(this ILogger logger, IConfiguration config, string name, LogEventLevel level, ConfigurationDiagnosticsOptions options = null)
        {
        ...
        {
            logger.LogConnectionString(config, name, LogEventLevel.Information, options);
        }
        ...
        {
            logger.LogConnectionString(config, name, LogEventLevel.Debug, options);
        }
        ...
        /// <param name="logger">The logger to send the details to.</param>
        /// <param name="options">The options to use, or <see cref="ConfigurationDiagnosticsOptions.GlobalOptions"/> if not specified.</param>
        public static void LogConnectionStringAsVerbose(this ILogger logger, IConfiguration config, string name, ConfigurationDiagnosticsOptions options)
        {
            logger.LogConnectionString(config, name, LogEventLevel.Verbose, options);
        }
        ...
        /// <param name="level">The level to log at.</param>
        /// <param name="options">The options to use, or <see cref="ConfigurationDiagnosticsOptions.GlobalOptions"/> if not specified.</param>
        public static void LogConnectionString(this ILogger logger, IDbConnection connection, LogEventLevel level, ConfigurationDiagnosticsOptions options = null)
        {
        ...
        {
            logger.LogConnectionString(connection, LogEventLevel.Information, options);
        }
        ...
        {
            logger.LogConnectionString(connection, LogEventLevel.Debug, options);
        }
        ...
        /// <param name="logger">The logger to send the details to.</param>
        /// <param name="options">The options to use, or <see cref="ConfigurationDiagnosticsOptions.GlobalOptions"/> if not specified.</param>
        public static void LogConnectionStringAsVerbose(this ILogger logger, IDbConnection connection, ConfigurationDiagnosticsOptions options = null)
        {
            logger.LogConnectionString(connection, LogEventLevel.Verbose, options);
        }
        ...
        /// <param name="options">The options to use, or <see cref="ConfigurationDiagnosticsOptions.GlobalOptions"/> if not specified.</param>
        public static void LogConnectionString(this ILogger logger, LogEventLevel level, string connectionString, string name = null, ConfigurationDiagnosticsOptions options = null)
        {
        ...
        {
            logger.LogConnectionString(LogEventLevel.Information, connectionString, name, options);
        }
        ...
        {
            logger.LogConnectionString(LogEventLevel.Debug, connectionString, name, options);
        }
        ...
        /// <param name="name">The name of the connection string, or null if there is no name or it is not known.</param>
        /// <param name="options">The options to use, or <see cref="ConfigurationDiagnosticsOptions.GlobalOptions"/> if not specified.</param>
        public static void LogConnectionStringAsVerbose(this ILogger logger, string connectionString, string name = null, ConfigurationDiagnosticsOptions options = null)
        {
            logger.LogConnectionString(LogEventLevel.Verbose, connectionString, name, options);
        }
    }
}